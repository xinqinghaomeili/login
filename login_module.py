...
from logindata import get_webinfo,get_userinfo,get_infodata,xluserinfo
...
logindata=get_webinfo('/Users/ply/Documents/pythontest/login/webinfo.txt')
userdata=get_userinfo('/Users/ply/Documents/pythontest/login/userinfo.txt')
infodata=get_infodata('/Users/ply/Documents/pythontest/login/infodata.txt')
...
#打开浏览器，输入URL
def openBrower(url):
	driver=webdriver.Chrome('/Users/ply/Downloads/chrome/chromedriver')
	driver.get(url['url'])
	return driver
